...
| `acs_residential_exposure_context` | ACS 5-year B01001/B25024/B25003 detailed tables | County-year ACS vintage | Age mix plus single-family/owner-occupied residential form as a public human-contact proxy candidate; ACS 5-year values are rolling survey estimates, not annual observed exposure | candidate_needs_api_key_or_static_summary_parser |
...
- ACS residential-form exposure context is still a candidate. The preferred
  detailed tables are `B01001`, `B25024`, and `B25003`, but they need either
  a Census API-key workflow or a static summary-file parser before promotion.
