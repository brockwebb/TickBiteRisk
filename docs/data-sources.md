...
| `delaware_dhss_lyme_table` | Review [Delaware DHSS Lyme data](https://dhss.delaware.gov/dph/epi/tick-lyme-data/) and save the page/table before extraction | Adjacent county-scale outcome candidate for the regional panel | official page has 2019-2023 county counts and rates; no 2024 county export verified yet; not a confirmed disease truth label |
| `virginia_vdh_reportable_disease_dashboard` | Use [Virginia Communicable Disease Data](https://www.vdh.virginia.gov/surveillance-and-investigation/virginia-communicable-disease-data/) and the linked 2024 annual report dashboard; save the dashboard export/API evidence before parsing | Could fill Virginia locality/county case history or 2024+ state-source overlays | candidate, needs official export check, dashboard/API structure review, and county/locality mapping; not a confirmed disease truth label |
| `west_virginia_oeps_vectorborne_reports` | Start with [WV OEPS Vectorborne Disease Report 10.25.24 PDF](https://oeps.wv.gov/arboviral/Documents/Data/Vectorborne%20Disease%20Report%2010.25.24.pdf) and any later official report directory entries | Provides 2024 statewide tickborne/Lyme context for all 55 WV counties, likely PDF/table extraction | candidate PDF extraction; may be YTD/provisional, not final county-year outcome truth; not a confirmed disease truth label |
| `dc_health_tickborne_report` | Review [DC Health Tickborne Diseases](https://dchealth.dc.gov/page/tickborne-diseases), [DC Health Lyme Disease](https://dchealth.dc.gov/page/lyme-disease), and the [2014-2020 summary PDF](https://dchealth.dc.gov/sites/default/files/dc/sites/doh/publication/attachments/Tickborne%20Diseases%20Summary%20report%202014%20to%202020.pdf) | DC is a county-equivalent in the regional footprint and needs jurisdiction-level caveats | candidate watch only; latest public summary found is historical rather than 2024 county panel; not a confirmed disease truth label |
| `mass_dph_monthly_tickborne_reports` | Download DOCX reports from [Massachusetts Monthly Tick-borne Disease Reports](https://www.mass.gov/lists/monthly-tick-borne-disease-reports) | Strong human-exposure/syndromic proxy with 2024, 2025, and 2026 monthly reports | future Northeast extension candidate; ED visits and diagnoses are exposure/syndromic signals, not a confirmed disease truth label |
| `maine_jmmc_2024_county_rates` | Use [Journal of Maine Medical Center article](https://knowledgeconnection.mainehealth.org/jmmc/vol7/iss2/10) and Maine Tracking dashboards before extraction | Peer-reviewed/open county-rate signal for 2024 Maine tickborne diseases | future Northeast extension candidate; rate table requires population/case reconciliation; not a confirmed disease truth label |
...
| `nj_doh_tickborne_page` | Review [NJ DOH tickborne page](https://www.nj.gov/health/cd/topics/tickborne.shtml) and [NJ vector-borne reports](https://www.nj.gov/health/cd/documents/topics/vectorborne/Vector_EOY_2024.pdf) | Adjacent Northeast extension with 2024 vector-borne summaries and ED/illness dashboard leads | candidate, may be report/PDF or dashboard rather than county-year table; not a confirmed disease truth label |
