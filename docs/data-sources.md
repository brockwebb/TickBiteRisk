...
| **MD\_DNR\_DEER** | [Maryland DNR deer harvest reports](https://news.maryland.gov/dnr/) and [annual report archive](https://dnr.maryland.gov/wildlife/Pages/hunt_trap/Deer_AnnualReports.aspx) | County/season deer harvest; white-tailed deer and sika deer where split | Annual (Feb/report publication) | Public state data | `tickbiterisk etl deer-harvest`; add `--include-annual-report-pdfs` for text-extractable 2011-12 through 2024-25 PDF history |
