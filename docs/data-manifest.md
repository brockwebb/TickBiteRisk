...
| `census_population` | Census PEP/intercensal county population | Census API | API JSON table | County | 1992-2023 supported | Incidence denominator | candidate, etl_supported, key_needed, acquisition_pending | Public federal data | ETL supports annual Maryland county denominators from 1990/2000 intercensal, 2019 PEP, and 2023 charv APIs. Live calls currently require `CENSUS_API_KEY`; 2024+ API source still needs confirmation |
