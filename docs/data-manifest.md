...
| `census_bps_county` | Census Building Permits Survey county ASCII files | `https://www2.census.gov/econ/bps/County/coYY12y.txt` | TXT/CSV-like ASCII | County | 2000-2025 practical county annual files | Construction/contact pressure proxy | acquired, etl_supported | Public federal data | `tickbiterisk etl building-permits` writes Maryland county-year units authorized and valuation fields; 2024 smoke wrote 24 rows from `24001`/24 units to `24510`/1273 units; full 2000-2025 smoke wrote 435 deduped rows because 2000-2004 have 16 jurisdictions, 2005-2014 have 14, 2015-2021 have 17, and 2022-2025 have 24; Census files can stall before first byte and fetchers retry transient failures |
