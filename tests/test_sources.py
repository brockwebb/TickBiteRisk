...
def test_project_docs_define_acquisition_provenance_contract() -> None:
    ...
    for token in [
        ...
        "ENSO, EnviroAtlas, USDM drought, Census population, building permits, county reference, deer harvest, Open-Meteo weather backfill, NOAA weather primitives, NOAA weather backfill, Lyme outcomes, aggregate Lyme validation, regional Lyme outcomes, seasonality baseline, tick status, and mast/acorn",
