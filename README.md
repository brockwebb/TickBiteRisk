...
The ensemble is not part of `annual-forecast` or the public county-week score
until its ridge/spatial components have a true target-year forecast contract.
